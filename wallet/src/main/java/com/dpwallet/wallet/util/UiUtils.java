...
import com.dpwallet.wallet.ui.AccountDetailsActivity;
import com.dpwallet.wallet.ui.EditAccountFragment;
import com.dpwallet.wallet.ui.EditAddressBookEntryFragment;
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                ...
                case R.id.action_copy:
                    ...
                    System.out.println("djbfdfdvf "+ string);
                    mode.finish();
                    return true;
            }
