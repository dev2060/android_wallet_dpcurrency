...
import com.dpwallet.core.coins.families.BitFamily;
import com.dpwallet.core.coins.families.NxtFamily;
import com.dpwallet.core.exceptions.UnsupportedCoinTypeException;
...
import com.dpwallet.wallet.ui.dialogs.CreateNewAddressDialog;
import com.dpwallet.wallet.ui.widget.AmountEditView;
import com.dpwallet.wallet.util.QrUtils;
...
import static com.dpwallet.wallet.ExchangeRatesProvider.getRate;
...
public class AddressRequestFragment extends WalletFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // or in com.dpwallet.wallet.ui.PreviousAddressesActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_copy:
                ...
                UiUtils.copy(getActivity(), getUriSimple());
                return true;
