...
public class IntroActivity extends AbstractWalletFragmentActivity
    ...
    private void startDigitalPriceWallet_(Bundle args) {
        ArrayList<String> ids_ = new ArrayList<String>();
        String moto_ = "digitalprice.main";
        ids_.add(moto_);
        Bundle args_ = args;
        args_.putStringArrayList(Constants.ARG_MULTIPLE_COIN_IDS, ids_);
        replaceFragment(FinalizeWalletRestorationFragment.newInstance(args_));
    }
