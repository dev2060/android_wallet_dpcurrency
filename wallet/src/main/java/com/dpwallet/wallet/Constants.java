package com.dpwallet.wallet;

import android.text.format.DateUtils;

import com.dpwallet.core.coins.AsiacoinMain;
import com.dpwallet.core.coins.AuroracoinMain;
import com.dpwallet.core.coins.BatacoinMain;
import com.dpwallet.core.coins.BitcoinMain;
import com.dpwallet.core.coins.BitcoinTest;
import com.dpwallet.core.coins.BlackcoinMain;
import com.dpwallet.core.coins.BurstMain;

import com.dpwallet.core.coins.ClubcoinMain;
import com.dpwallet.core.coins.CoinID;
import com.dpwallet.core.coins.CoinType;
import com.dpwallet.core.coins.DashMain;
import com.dpwallet.core.coins.DigibyteMain;
import com.dpwallet.core.coins.DigitalPriceMain;
import com.dpwallet.core.coins.DigitalcoinMain;
import com.dpwallet.core.coins.DogecoinMain;
import com.dpwallet.core.coins.DogecoinTest;
import com.dpwallet.core.coins.EguldenMain;

import com.dpwallet.core.coins.LitecoinMain;
import com.dpwallet.core.coins.LitecoinTest;
import com.dpwallet.core.coins.MonacoinMain;

import com.dpwallet.core.coins.SteepcoinMain;
import com.dpwallet.core.coins.TritiumMain;

import com.dpwallet.core.coins.EvotionCoinMain;
import com.dpwallet.core.coins.RealPointCoinMain;
import com.dpwallet.core.network.CoinAddress;
import com.dpwallet.stratumj.ServerAddress;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/MS/DPWallet-Android/tree/master/binaries";

    public static final String VERSION_URL = "http://89.40.2.144";
    //public static final String VERSION_URL = "https://vasilkoff.com/version.html";
    //public static final String SUPPORT_EMAIL = "support@dpwallet.com";
    public static final String SUPPORT_EMAIL = "dev.vasilkoff@gmail.com";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(

            new CoinAddress(DigitalPriceMain.get(),      new ServerAddress("51.68.121.255", 50015)/*,
                                                    new ServerAddress("89.40.2.143", 8001)*/)
    );
...
//        COINS_ICONS.put(CoinID.DOGECOIN_MAIN.getCoinType(), R.drawable.dogecoin);
        COINS_ICONS.put(CoinID.DIGITALPRICE_MAIN.getCoinType(), R.drawable.digitalprice);

        COINS_BLOCK_EXPLORERS = new HashMap<CoinType, String>();
        COINS_BLOCK_EXPLORERS.put(CoinID.DIGITALPRICE_MAIN.getCoinType(), "http://188.226.151.189:3072/tx/%s");
    }
