...
import com.dpwallet.core.coins.FiatValue;
import com.dpwallet.core.coins.Value;
import com.dpwallet.core.util.ExchangeRateBase;
...
public class ExchangeRatesProvider extends ContentProvider {
    ...
    private static final String BASE_URL = "https://ticker.dpwallet.net/simple";
    ...
    private static final String DPWALLET_SOURCE = "dpwallet.com";
                ...
                if (!"extras".equals(toSymbol)) {
                    ...
                    if (rateStr != null) {
                        try {
                            ...
                            rates.put(toSymbol, new ExchangeRate(rate, toSymbol, DPWALLET_SOURCE));
