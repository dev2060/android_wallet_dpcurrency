package com.dpwallet.core.coins.nxt;
...
//                + " existing key " + com.dpwallet.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.dpwallet.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.dpwallet.core.coins.nxt.Crypto.rsDecode(com.dpwallet.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.dpwallet.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.dpwallet.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.dpwallet.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.dpwallet.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.dpwallet.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.dpwallet.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
